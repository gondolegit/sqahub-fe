export default {
  ...
  "testSuites": {
    ...
    "junitImport": {
      "button": "Import CI/CD",
      "buttonTitle": "Import laporan JUnit XML dari CI/CD sebagai Test Suite Run baru",
      "title": "Import Laporan JUnit XML",
      "description": "Unggah laporan JUnit XML dari CI/CD (Maven Surefire, Jest, pytest, Playwright, dll.) — akan langsung menjadi Test Suite Run baru yang sudah difinalisasi.",
      "fileLabel": "File Laporan (.xml)",
      "formatHint": "Setiap <testcase> dicocokkan ke Test Case yang sudah ada berdasarkan nama; yang tidak cocok akan dibuat otomatis.",
      "defaultFeatureLabel": "Feature Default untuk Test Case Baru",
      "defaultFeaturePlaceholder": "Pilih Feature",
      "defaultFeatureHint": "Dipakai untuk test case dari laporan yang belum ada di SQAHUB.",
      "stageLabel": "Test Stage",
      "environmentLabel": "Test Environment",
      "nameLabel": "Nama Test Suite (opsional)",
      "namePlaceholder": "Kosongkan untuk nama otomatis",
      "submit": "Unggah & Import",
      "passed": "Passed",
      "failed": "Failed",
      "error": "Error",
      "skipped": "Skipped",
      "suiteCreated": "Test Suite Run '{{name}}' berhasil dibuat dan difinalisasi.",
      "matchedCount": "{{count}} cocok dengan Test Case yang sudah ada",
      "autoCreatedCount": "{{count}} Test Case dibuat otomatis",
      "warningsTitle": "Catatan",
      "importAnother": "Import Laporan Lain",
      "done": "Selesai"
    },
