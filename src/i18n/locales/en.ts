export default {
  ...
  "testSuites": {
    ...
    "junitImport": {
      "button": "Import from CI/CD",
      "buttonTitle": "Import a JUnit XML report from CI/CD as a new Test Suite Run",
      "title": "Import JUnit XML Report",
      "description": "Upload a JUnit XML report from CI/CD (Maven Surefire, Jest, pytest, Playwright, etc.) — it becomes a new, already-finalized Test Suite Run.",
      "fileLabel": "Report File (.xml)",
      "formatHint": "Each <testcase> is matched to an existing Test Case by name; unmatched ones are created automatically.",
      "defaultFeatureLabel": "Default Feature for New Test Cases",
      "defaultFeaturePlaceholder": "Select a Feature",
      "defaultFeatureHint": "Used for test cases from the report that don't exist in SQAHUB yet.",
      "stageLabel": "Test Stage",
      "environmentLabel": "Test Environment",
      "nameLabel": "Test Suite Name (optional)",
      "namePlaceholder": "Leave blank for an automatic name",
      "submit": "Upload & Import",
      "passed": "Passed",
      "failed": "Failed",
      "error": "Error",
      "skipped": "Skipped",
      "suiteCreated": "Test Suite Run '{{name}}' was created and finalized.",
      "matchedCount": "{{count}} matched an existing Test Case",
      "autoCreatedCount": "{{count}} Test Cases created automatically",
      "warningsTitle": "Notes",
      "importAnother": "Import Another Report",
      "done": "Done"
    },
